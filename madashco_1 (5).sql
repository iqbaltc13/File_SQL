...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2018 at 07:15 AM
...
(1, 'PROM', 'PROM', 'ckccnhzsbtszn', NULL, NULL);
...
INSERT INTO `produk` (`id`, `id_Etalase`, `id_Kategori`, `id_Merek`, `nama_Produk`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 'woo_product', NULL, NULL),
(3, 1, 6, 4, 'Tang oke', NULL, NULL),
(4, 1, 6, 5, 'Tang oke', NULL, NULL),
(5, 1, 2, 6, 'wajan', NULL, NULL),
(6, 1, 9, 7, 'tes engsel', NULL, NULL),
(7, 1, 9, 8, 'tes 3 engsel', NULL, NULL),
(8, 1, 11, 9, 'kompor', NULL, NULL);
