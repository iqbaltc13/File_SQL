...
--
-- Struktur dari tabel `tokopedias`
--
...
(1, 'iqbalmaula ', 'rifqimaula@gmail.com', '$2y$10$q9EWV2pwk0p2LHNMbm78quyoiGqmmImXHrDen7sp./1y0YPexIWUW', 0, 0, '88888', '', 0, 1115400992, '', '', '', '', '0000-00-00', '0000-00-00', NULL, '2018-01-30 01:18:12', '2018-01-30 01:18:12');
...
--
-- Struktur dari tabel `varian_atr`
--
...
--
-- Struktur dari tabel `woocommerces`
--
...
--
-- Struktur dari tabel `woo_categories`
--
...
--
-- Struktur dari tabel `woo_img_prods`
--
...
--
-- Struktur dari tabel `woo_prod_tags`
--
...
--
-- Struktur dari tabel `woo_prod_taxclasses`
--
...
--
-- Struktur dari tabel `woo_pro_cats`
--
...
--
-- Ketidakleluasaan untuk tabel `layer1s`
--
ALTER TABLE `layer1s`
...
--
-- Ketidakleluasaan untuk tabel `layer2s`
--
ALTER TABLE `layer2s`
  ADD CONSTRAINT `layer2s_id_layer1_foreign` FOREIGN KEY (`id_Layer1`) REFERENCES `events` (`id`),
...
--
-- Ketidakleluasaan untuk tabel `profile_d`
--
ALTER TABLE `profile_d`
...
--
-- Ketidakleluasaan untuk tabel `profile_h`
--
ALTER TABLE `profile_h`
...
--
-- Ketidakleluasaan untuk tabel `tokopedias`
--
ALTER TABLE `tokopedias`
...
--
-- Ketidakleluasaan untuk tabel `varian_atr`
--
ALTER TABLE `varian_atr`
...
--
-- Ketidakleluasaan untuk tabel `woo_prod_tags`
--
ALTER TABLE `woo_prod_tags`
...
--
-- Ketidakleluasaan untuk tabel `woo_prod_taxclasses`
--
ALTER TABLE `woo_prod_taxclasses`
...
--
-- Ketidakleluasaan untuk tabel `woo_pro_cats`
--
ALTER TABLE `woo_pro_cats`
