...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 23, 2018 at 08:44 AM
...
--
-- Truncate table before insert `detail_barang`
--

TRUNCATE TABLE `detail_barang`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `etalase`
--

TRUNCATE TABLE `etalase`;
--
...
--
-- Truncate table before insert `facebook_produks`
--

TRUNCATE TABLE `facebook_produks`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `harga_grosir`
--

TRUNCATE TABLE `harga_grosir`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `instagram_produks`
--

TRUNCATE TABLE `instagram_produks`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `merek`
--

TRUNCATE TABLE `merek`;
--
...
--
-- Truncate table before insert `profile_d`
--

TRUNCATE TABLE `profile_d`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `profile_h`
--

TRUNCATE TABLE `profile_h`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `simpan`
--

TRUNCATE TABLE `simpan`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `tokopedias`
--

TRUNCATE TABLE `tokopedias`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `varian`
--
...
--
-- Truncate table before insert `varian_atr`
--

TRUNCATE TABLE `varian_atr`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `woocommerces`
--

TRUNCATE TABLE `woocommerces`;
--
...
--
-- Truncate table before insert `woo_categories`
--

TRUNCATE TABLE `woo_categories`;
--
...
--
-- Truncate table before insert `woo_img_prods`
--

TRUNCATE TABLE `woo_img_prods`;
--
...
--
-- Truncate table before insert `woo_prod_tags`
--

TRUNCATE TABLE `woo_prod_tags`;
--
...
--
-- Truncate table before insert `woo_prod_taxclasses`
--

TRUNCATE TABLE `woo_prod_taxclasses`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `woo_pro_cats`
--

TRUNCATE TABLE `woo_pro_cats`;
--
...
--
-- Truncate table before insert `woo_tags`
--

TRUNCATE TABLE `woo_tags`;
--
...
--
-- Truncate table before insert `woo_tax_classes`
--

TRUNCATE TABLE `woo_tax_classes`;
--
